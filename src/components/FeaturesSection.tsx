...
export default function FeaturesSection() {
  ...
  return (
    <ScrollSection id="experience" className="bg-slate-900 py-24 relative overflow-hidden">
      ...
      <div className="space-y-8">
        {experiences.map((experience, index) => (
          <ScrollItem 
            key={experience.id} 
            delay={index * 0.1}
            className="bg-slate-800/50 border border-slate-700 rounded-xl p-6 shadow-lg hover:shadow-blue-500/5 transition-shadow relative overflow-hidden"
          >
            {experience.current && (
